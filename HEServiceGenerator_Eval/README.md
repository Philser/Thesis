This is the maven software project of the service generator component of the prototype, adapted to conduct various evaluations.
...
Evaluation/Measurements:
	This service does not conduct the arithmetic function it is provided.
	Instead, it conducts various measurements.
	These can be found and adapted in the file [...]\HEServiceGenerator_Eval\src\main\java\resources\service\templates\he_code_template.stg

	The measurements are conducted directly in HElib.
	Therefore, knowledge of HELib and C++ is beneficial.